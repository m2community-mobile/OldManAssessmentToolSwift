//
//  ResultShowViewController2.swift
...
class ResultShowViewController2: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let titleView2 = ToolTitleView2(frame: CGRect(x: 0, y: 0, width: SCREEN.WIDTH * TOOL_VIEW_CONTENT_WIDTH_RATIO, height: 200), index: self.index, infoDic: self.infoDic)
        ...
        bottomView.frame.size.height = scoreBackView.frame.maxY
